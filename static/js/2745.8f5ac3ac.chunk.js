...
`},46457(e,r,i){i.d(r,{S:()=>o});var t=i(70579),n=i(25485),a=i(74420);const o=e=>{let{primaryCta:r,secondaryCta:i,helpText:o,footerText:l,watermark:s=!0,children:c,...d}=e,p=r||i?(0,t.jsxs)(t.Fragment,{children:[r&&(()=>{let{label:e,...i}=r,a=i.variant||"primary";return(0,t.jsx)(n.a,{...i,variant:a,style:{width:"100%",...i.style},children:e})})(),i&&(()=>{let{label:e,...r}=i,a=r.variant||"secondary";return(0,t.jsx)(n.a,{...r,variant:a,style:{width:"100%",...r.style},children:e})})()]}):null;return(0,t.jsxs)(a.S,{id:d.id,className:d.className,children:[(0,t.jsx)(a.S.Header,{...d}),c?(0,t.jsx)(a.S.Body,{children:c}):null,o||p||s?(0,t.jsxs)(a.S.Footer,{children:[o?(0,t.jsx)(a.S.HelpText,{children:o}):null,p?(0,t.jsx)(a.S.Actions,{children:p}):null,s?(0,t.jsx)(a.S.Watermark,{}):null]}):null,l?(0,t.jsx)(a.S.FooterText,{children:l}):null]})}},72745(e,r,i){i.r(r),i.d(r,{UpdatePhoneScreen:()=>p,UpdatePhoneScreenView:()=>d,default:()=>p});var t=i(70579),n=i(89850),a=i(65043),o=i(19733),l=i(4204),s=i(37446),c=i(46457);i(71949),i(26799),i(8738);const d=e=>{let{title:r="Update your phone number",subtitle:i="Add the phone number you'd like to use going forward. We'll send you a confirmation code",onSubmit:l,isSubmitting:s=!1}=e,[d,p]=(0,a.useState)(null);return(0,t.jsx)(c.S,{title:r,subtitle:i,icon:n.A,primaryCta:{label:s?"Submitting":"Update",onClick:async()=>{d?.qualifiedPhoneNumber&&await l(d)},disabled:!d?.isValid||s},watermark:!0,children:(0,t.jsx)(o.C,{onChange:e=>{p(e)},onSubmit:async()=>{},noIncludeSubmitButton:!0,hideRecent:!0})})},p={component:()=>{let{currentScreen:e,data:r,navigate:i,setModalData:n}=(0,s.a)(),{user:o}=(0,s.u)(),{initUpdatePhone:c}=(0,l.u)(),[p,u]=(0,a.useState)(!1);return(0,t.jsx)(d,{onSubmit:async t=>{u(!0);try{if(!o?.phone?.number)throw Error("User is required to have an phone number to update it.");await c(o?.phone?.number,t.qualifiedPhoneNumber),i("AwaitingPasswordlessCodeScreen")}catch(t){n({errorModalData:{error:t,previousScreen:r?.errorModalData?.previousScreen||e||"LinkPhoneScreen"}}),i("ErrorScreen")}finally{u(!1)}},isSubmitting:p})}}},28614(e,r,i){i.d(r,{N:()=>a});var t=i(70579),n=i(62153);const a=e=>{let{size:r,centerIcon:i}=e;return(0,t.jsx)(o,{$size:r,children:(0,t.jsxs)(l,{children:[(0,t.jsx)(c,{}),(0,t.jsx)(d,{}),i?(0,t.jsx)(s,{children:i}):null]})})};let o=n.I4.div`
...
`}}]);
//# sourceMappingURL=2745.8f5ac3ac.chunk.js.map